...
import { CheckCircle, Clock, Edit2, MoreVertical, Plus, Search, Trash2 } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";
import { toast } from "sonner";
//#region src/routes/trainer/assessments/index.jsx?tsr-split=component
...
function AssessmentsView() {
	...
	const filteredAssessments = assessments.filter((a) => a.title.toLowerCase().includes(search.toLowerCase()) || a.course.toLowerCase().includes(search.toLowerCase()));
		...
		children: [
			/* @__PURE__ */ jsx(ModuleHeroBanner, {
				...
				actions: /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }), " Create Assessment"]
				})
			}),
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: filteredAssessments.map((assessment) => /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						scale: .95
					},
					...
					children: [/* @__PURE__ */ jsx("div", {
						className: `h-24 bg-gradient-to-r ${assessment.gradient} p-4 flex flex-col justify-between relative`,
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsx("button", {
								...
								}), /* @__PURE__ */ jsx(AnimatePresence, { children: activeMenuId === assessment.id && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("button", {
											...
											children: [/* @__PURE__ */ jsx(Edit2, { className: "w-3.5 h-3.5 text-blue-500" }), "Edit Rubric/Details"]
										}),
										...
										/* @__PURE__ */ jsxs("button", {
											...
											children: [/* @__PURE__ */ jsx(Trash2, { className: "w-3.5 h-3.5" }), "Delete Assessment"]
										})
									]
								})] }) })]
							})]
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("h3", {
									className: "font-bold text-lg leading-tight text-foreground line-clamp-2 group-hover:text-primary transition-colors",
							...
							/* @__PURE__ */ jsxs("div", {
								className: "space-y-3",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "bg-secondary/30 p-3 rounded-xl border border-border/40 space-y-2 text-sm",
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", {
											...
											children: [
												...
												/* @__PURE__ */ jsxs("span", {
													...
													children: ["/ ", assessment.totalStudents]
												})
											]
										})]
									}), /* @__PURE__ */ jsx("div", {
									...
									className: "flex items-center gap-2 text-xs font-medium bg-red-500/5 text-red-500 p-2.5 rounded-xl border border-red-500/20",
									children: [/* @__PURE__ */ jsx(Clock, { className: "w-4 h-4" }), /* @__PURE__ */ jsxs("span", { children: ["Due: ", assessment.due] })]
								})]
							}),
							/* @__PURE__ */ jsx("div", {
								className: "pt-2 border-t border-border/40",
								children: /* @__PURE__ */ jsxs("button", {
									onClick: () => toast.info("Opening Submissions Viewer"),
									className: "w-full btn-hero py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer flex items-center justify-center gap-1.5",
									children: [/* @__PURE__ */ jsx(CheckCircle, { className: "w-3.5 h-3.5" }), " Grade Submissions"]
								})
							})
						]
					})]
