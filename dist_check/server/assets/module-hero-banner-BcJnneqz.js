...
//#region src/components/module-hero-banner.jsx
/**
* ModuleHeroBanner
...
*/
function ModuleHeroBanner({ breadcrumb, title, subtitle, badgeText, actions }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-6 sm:p-7",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "space-y-1.5 min-w-0",
					children: [
						breadcrumb && /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest",
							style: { color: "oklch(0.55 0.16 320)" },
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary animate-pulse shrink-0" }), breadcrumb]
						}),
						/* @__PURE__ */ jsx("h1", {
					...
					children: [badgeText && /* @__PURE__ */ jsxs(motion.span, {
						animate: { boxShadow: [
						...
						children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_6px_oklch(0.7_0.2_145)]" }), badgeText]
