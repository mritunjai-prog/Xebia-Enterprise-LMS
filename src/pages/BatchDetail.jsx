             ...
             <div className="space-y-3">
                {assignedAssessments.length === 0 ? (
                   ...
                   assignedAssessments.map(asmt => (
                      <div key={asmt.id} className="p-4 rounded-2xl border border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-800/30 hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate({ to: '/trainer/assessment-builder' })}>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="relative w-full max-w-lg bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 p-8 space-y-6">
              ...
              <form onSubmit={handleSaveEdit} className="space-y-5 text-sm">
                <div className="space-y-2">
                  <label className="block font-bold text-neutral-600 dark:text-neutral-300">Batch Name <span className="text-destructive">*</span></label>
                  <input
                    type="text"
                    required
                    value={editName}
                ...
                <div className="space-y-2">
                  <label className="block font-bold text-neutral-600 dark:text-neutral-300">Course / Core Focus <span className="text-destructive">*</span></label>
                  <input
                    type="text"
                    required
                    value={editCourse}
