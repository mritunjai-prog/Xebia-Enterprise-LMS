...
export const BatchDetail = () => {
  ...
  const batch = useMemo(
    () => batches.find((b) => b.name === decodeURIComponent(id)),
    [batches, id],
  );
  ...
  const renderIcon = (icon) => {
    ...
    if (
      ...
      return (
        <img src={imgSrc} alt="" className="w-full h-full object-contain rounded-[28px] p-2" />
      );
    }
        ...
        {iconTab === "url" && (
          <div className="w-full space-y-3">
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#6C1D5F] dark:text-white"
            />
            {batchIconUrl && (
              <img
                src={batchIconUrl}
                alt="Preview"
                className="w-16 h-16 mx-auto object-cover rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 mt-2 bg-white"
          ...
          <div className="w-full space-y-3 flex flex-col items-center">
            ...
            {batchIconUpload && (
              <img
                src={batchIconUpload}
                alt="Preview"
                className="w-16 h-16 object-cover rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 bg-white"
              />
            )}
          </div>
        )}
  ...
  const handleSaveEdit = (e) => {
    ...
    if (editName.trim() !== batch.name) {
      navigate(`/trainer/batches/${encodeURIComponent(editName.trim())}`);
    }
  };
  ...
  if (!batch) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-neutral-500">
        ...
        <button
          onClick={() => navigate({ to: "/trainer/batches" })}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        <button
          onClick={() => navigate({ to: "/trainer/batches" })}
          className="flex items-center gap-2 text-neutral-500 dark:text-neutral-400 hover:text-[#6C1D5F] dark:hover:text-[#6C1D5F] transition-colors cursor-pointer font-bold bg-neutral-100 dark:bg-neutral-800 hover:bg-primary/10 dark:hover:bg-primary px-3 py-1.5 rounded-lg"
        >
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 w-full">
          ...
          <div className="flex items-center gap-5">
            {/* Icon */}
            <div className="w-20 h-20 shrink-0 bg-primary/10 dark:bg-primary rounded-2xl flex items-center justify-center text-4xl shadow-sm border border-primary/20 dark:border-primary overflow-hidden">
            ...
            <div className="flex flex-col items-start justify-center h-20">
              ...
              <div className="flex items-center gap-3 mt-1.5">
                <p className="text-sm font-bold text-neutral-600 dark:text-neutral-400 flex items-center gap-1.5">
                  <BookOpen className="w-4 h-4 text-primary dark:text-primary" /> {batch.course}
                </p>
                <span
                  className={`inline-block px-2 py-0.5 font-extrabold rounded text-[10px] uppercase font-mono ${
                    batch.status === "active"
                      ? "bg-accent-2/10 text-accent-2 dark:bg-accent-2 dark:text-accent-2"
        ...
        <div className="w-full bg-neutral-50 dark:bg-neutral-800/40 rounded-2xl p-4 sm:p-5 flex flex-wrap gap-x-12 gap-y-6 items-center">
          <div className="flex flex-col gap-1">
            <span className="text-[11px] font-bold text-neutral-400 dark:text-neutral-500 tracking-wider">
              Duration
            </span>
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm font-bold text-neutral-800 dark:text-neutral-200 font-mono">
              {batch.studentCount}
            </span>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex items-center justify-start gap-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-xl font-black text-neutral-800 dark:text-white font-mono leading-none">
              {batch.studentCount}{" "}
              <span className="text-sm font-bold text-neutral-400 dark:text-neutral-500 font-sans tracking-normal ml-1">
                Students
              </span>
            </p>
          </div>
        ...
        <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex items-center justify-start gap-4">
          <div className="w-12 h-12 shrink-0 bg-primary/10 dark:bg-primary text-[#6C1D5F] dark:text-primary rounded-xl flex items-center justify-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-xl font-black text-neutral-800 dark:text-white font-mono leading-none flex items-baseline gap-1.5">
              {progress}%{" "}
              <span className="text-[11px] font-bold text-neutral-400 dark:text-neutral-500 font-sans tracking-normal hidden sm:inline-block">
                Average Completion
              </span>
            </p>
          </div>
        ...
        {/* KPI: Assessments */}
        <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex items-center justify-start gap-4">
          <div className="w-12 h-12 shrink-0 bg-destructive/10 dark:bg-destructive text-destructive rounded-xl flex items-center justify-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-xl font-black text-neutral-800 dark:text-white font-mono leading-none">
              {assignedAssessments.length}{" "}
              <span className="text-[11px] font-bold text-neutral-400 dark:text-neutral-500 font-sans tracking-normal hidden sm:inline-block ml-1">
                Total Created
              </span>
            </p>
          </div>
        ...
        {/* KPI: Avg Score */}
        <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm flex items-center justify-start gap-4">
          <div className="w-12 h-12 shrink-0 bg-accent-2/10 dark:bg-accent-2 text-accent-2 rounded-xl flex items-center justify-center">
                ...
                <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800 bg-white dark:bg-neutral-900">
                  {enrolledStudents.length === 0 ? (
                    <tr>
                      <td
                        colSpan={3}
                        className="px-6 py-12 text-center text-neutral-500 font-medium bg-neutral-50/50 dark:bg-neutral-900/30"
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <img
                              src={student.avatar}
                              alt=""
                              className="w-10 h-10 rounded-full border border-neutral-200 dark:border-neutral-700 shadow-sm"
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1">
                            <span className="text-xs font-bold text-neutral-600 dark:text-neutral-400">
                              {student.assessmentsCompleted || 0} / {assignedAssessments.length}{" "}
                              Completed
                            </span>
                            <div className="w-24 bg-neutral-100 dark:bg-neutral-800 rounded-full h-1.5 overflow-hidden">
                              <div
                                ...
                                style={{
                                  width: `${assignedAssessments.length ? ((student.assessmentsCompleted || 0) / assignedAssessments.length) * 100 : 0}%`,
                                }}
                              ></div>
                            </div>
                          </div>
            ...
            <div className="space-y-3">
              {assignedAssessments.length === 0 ? (
                ...
                assignedAssessments.map((asmt) => (
                  <div
                    key={asmt.id}
                    className="p-4 rounded-2xl border border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-800/30 hover:shadow-md transition-shadow cursor-pointer"
                    onClick={() => navigate({ to: "/trainer/assessment-builder" })}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-bold text-neutral-800 dark:text-neutral-200 leading-tight">
                        {asmt.title}
                      </h3>
                      <span className="px-2 py-0.5 bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded text-[10px] font-bold uppercase shrink-0">
                        {asmt.status}
                      </span>
                    </div>
                    <div className="flex items-center gap-3 text-xs font-semibold text-neutral-500">
                      <span className="flex items-center gap-1">
                        <Clock className="w-3.5 h-3.5" /> {asmt.duration}m
                      </span>
                      <span className="flex items-center gap-1">
                        <CheckCircle className="w-3.5 h-3.5" /> {asmt.type}
                      </span>
                    </div>
                  </div>
                ))
        ...
        {isAddStudentsModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 flex flex-col overflow-hidden max-h-[85vh]"
            >
                  ...
                  <label className="flex items-center gap-3 cursor-pointer w-fit group select-none ml-1">
                    <div className="relative flex items-center justify-center">
                      <input
                        ...
                        checked={
                          filteredStudents.length > 0 &&
                          filteredStudents.every((s) => tempStudentIds.includes(s.id))
                        }
                ...
                {filteredStudents.length === 0 ? (
                  ...
                  <div className="space-y-1">
                    {filteredStudents.map((student) => (
                      <label
                        key={student.id}
                        className="flex items-center gap-4 p-3 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-xl cursor-pointer transition-colors border border-transparent hover:border-neutral-100 dark:hover:border-neutral-700/50 group"
                      >
                        <div className="relative flex items-center justify-center">
                          <input
                            type="checkbox"
                            checked={tempStudentIds.includes(student.id)}
              ...
              <div className="p-6 border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/50 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-bold bg-[#6C1D5F] hover:bg-[#4A1E47] text-white transition-colors flex items-center gap-2"
                >
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="relative w-full max-w-lg bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 p-8 space-y-6"
            >
              ...
              <form onSubmit={handleSaveEdit} className="space-y-5 text-sm">
                ...
                <div className="pt-4 flex gap-3">
                  <button
                    type="button"
                    onClick={() => setIsEditModalOpen(false)}
                    className="flex-1 py-3 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 font-bold rounded-xl transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 py-3 bg-[#6C1D5F] hover:bg-[#4A1E47] text-white font-bold rounded-xl transition-colors shadow-lg"
                  >
                    Save Changes
                  </button>
                </div>
