                      ...
                      <div>
                        <div className="flex justify-between items-center text-xs mb-2">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="font-black text-[#6C1D5F] dark:text-primary font-mono">{progress}%</span>
                            <div className="relative group/menu" onClick={e => e.stopPropagation()}>
                              ...
                              <div className="absolute right-0 bottom-full mb-1 w-36 bg-white dark:bg-neutral-800 rounded-xl shadow-xl border border-neutral-100 dark:border-neutral-700 opacity-0 invisible group-hover/menu:opacity-100 group-hover/menu:visible transition-all z-20 py-1">
                                ...
                                <button onClick={(e) => handleDeleteClick(e, batch.id, batch.name)} className="w-full text-left px-3 py-1.5 text-xs font-bold hover:bg-destructive/10 dark:hover:bg-destructive text-destructive cursor-pointer">
                                  Delete Batch
                                </button>
                              </div>
                            </div>
              ...
              <form onSubmit={handleCreateSubmit} className="space-y-5 text-sm">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="block font-bold text-neutral-600 dark:text-neutral-300">Title <span className="text-destructive">*</span></label>
                    <input
                      type="text"
                      required
                      value={batchName}
