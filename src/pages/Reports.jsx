      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-brand-border dark:border-neutral-700 dark:border-neutral-800 p-5 rounded-2xl flex items-center justify-between shadow-md">
          <div>
            ...
            <h4 className="text-2xl font-display font-black text-[#6C1D5F] dark:text-primary mt-1">{averageScore}%</h4>
        ...
        <div className="bg-white dark:bg-neutral-900 border border-brand-border dark:border-neutral-700 dark:border-neutral-800 p-5 rounded-2xl flex items-center justify-between shadow-md">
          <div>
            ...
            <h4 className="text-2xl font-display font-black text-[#01AC9F] dark:text-accent-2 mt-1">{passPercent}%</h4>
        ...
        <div className="bg-white dark:bg-neutral-900 border border-brand-border dark:border-neutral-700 dark:border-neutral-800 p-5 rounded-2xl flex items-center justify-between shadow-md">
          <div>
            ...
            <div className="flex items-baseline gap-2 mt-1">
              <span className="text-xl font-display font-black text-neutral-800 dark:text-white flex items-center"><ArrowUp className="w-4 h-4 text-accent-2 shrink-0" />{highestScore}%</span>
                ...
                return (
                  <tr key={stud.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/20 transition-colors">
                      ...
                      <td className="py-3 text-right font-mono font-bold text-neutral-800 dark:text-white pr-2">
                        <span className={`px-2 py-0.5 rounded ${score >= 85 ? 'bg-accent-2/10 text-accent-2 dark:bg-accent-2 dark:text-accent-2' : score >= 70 ? 'bg-primary/10 text-primary dark:bg-primary dark:text-primary' : 'bg-rose-50 text-rose-800 dark:bg-rose-950/20 dark:text-rose-300'}`}>
                          {score}%
                        </span>
                      </td>
                    </tr>);
