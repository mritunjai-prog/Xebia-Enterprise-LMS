        ...
        <Link to="/student/courses" className="group">
          <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#15151f] p-6 sm:p-8 flex items-center justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-0">
            ...
            <div className="relative z-10">
              <p className="text-muted-foreground text-sm font-bold tracking-wider uppercase mb-1">Jump Back In</p>
              <h3 className="text-foreground text-2xl font-extrabold group-hover:text-[#6C1D5F] dark:group-hover:text-[#D3CCEC] transition-colors">Resume Last Course</h3>
            </div>
        ...
        >
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Hours spent learning</p>
            </div>
          </div>
        ...
        >
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Assessment scores</p>
            </div>
          </div>
          <div className="flex-1 min-h-[300px]">
