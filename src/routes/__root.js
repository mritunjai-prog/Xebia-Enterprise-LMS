...
export const Route = createRootRouteWithContext()({
    head: () => ({
        meta: [
            ...
            { name: "description", content: "Enterprise-grade Learning Management System for universities, organisations and enterprises. Identity, courses, assessments, video learning and reporting on one multi-tenant platform." },
            { name: "author", content: "Xebia" },
            { property: "og:title", content: "Xebia Enterprise LMS" },
            { property: "og:description", content: "One platform for universities, organisations and enterprise learning." },
...
function RootComponent() {
    ...
    return (_jsxs(QueryClientProvider, { client: queryClient, children: [_jsx(Outlet, {}), _jsx(CursorTrail, {})] }));
}
