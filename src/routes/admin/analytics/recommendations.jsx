    ...
    <div className="min-h-screen bg-background text-gray-900 dark:text-gray-100 p-6 md:p-8 font-sans transition-colors duration-300 space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] flex flex-col justify-between h-full group">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Recommendation Acceptance Rate</p>
            <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">74.5%</h4>
            <p className="text-xs text-gray-400 mt-2 font-medium">Employees enrolling in AI-suggested learning paths</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] flex flex-col justify-between h-full group">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Completion Rate of Suggestions</p>
        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-6 flex flex-col transition-all duration-300 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">High-Impact Course Recommendations</h3>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 border border-gray-100 dark:border-white/5 rounded-xl bg-gray-50/50 dark:bg-white/5 hover:bg-white dark:hover:bg-[#151515] hover:border-[#01AC9F] transition-all cursor-pointer group">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white group-hover:text-[#01AC9F] transition-colors">Advanced Prompt Engineering</h4>
                  <p className="text-xs text-gray-500 mt-1">Suggested for: 840 Employees (Data & AI Practice)</p>
                </div>
                <span className="px-2 py-1 bg-[#01AC9F]/10 text-[#01AC9F] rounded text-[10px] font-black border border-[#01AC9F]/20">92% MATCH</span>
              </div>
            </div>
            ...
            <div className="p-4 border border-gray-100 dark:border-white/5 rounded-xl bg-gray-50/50 dark:bg-white/5 hover:bg-white dark:hover:bg-[#151515] hover:border-[#FF6200] transition-all cursor-pointer group">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white group-hover:text-[#FF6200] transition-colors">AWS Certified Solutions Architect</h4>
                  <p className="text-xs text-gray-500 mt-1">Suggested for: 320 Employees (Cloud Practice)</p>
                </div>
                <span className="px-2 py-1 bg-[#FF6200]/10 text-[#FF6200] rounded text-[10px] font-black border border-[#FF6200]/20">88% MATCH</span>
              </div>
            </div>
            ...
            <div className="p-4 border border-gray-100 dark:border-white/5 rounded-xl bg-gray-50/50 dark:bg-white/5 hover:bg-white dark:hover:bg-[#151515] hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-all cursor-pointer group">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="text-sm font-bold text-gray-900 dark:text-white group-hover:text-[#6C1D5F] dark:group-hover:text-[#FFACE8] transition-colors">Zero Trust Architecture Fundamentals</h4>
                  <p className="text-xs text-gray-500 mt-1">Suggested for: 410 Employees (Cybersecurity)</p>
                </div>
                <span className="px-2 py-1 bg-[#6C1D5F]/10 text-[#6C1D5F] dark:text-[#FFACE8] rounded text-[10px] font-black border border-[#6C1D5F]/20">85% MATCH</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-6 flex flex-col transition-all duration-300 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Suggested Career Path Transitions</h3>
            </div>
          </div>
          ...
          <div className="space-y-6 flex-1">
            ...
            <div className="relative pl-6 border-l-2 border-gray-200 dark:border-white/10 group cursor-pointer">
              ...
              <div className="flex items-center gap-3 text-sm font-bold mb-2">
                ...
                <span className="text-[#6C1D5F] dark:text-[#FFACE8]">Full-Stack Cloud Engineer</span>
              </div>
              <p className="text-xs text-gray-500 mb-2">Targeted to: 240 Employees</p>
              <div className="flex gap-2">
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">React.js Deep Dive</span>
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">AWS Cloud Practitioner</span>
              </div>
            </div>
            ...
            <div className="relative pl-6 border-l-2 border-gray-200 dark:border-white/10 group cursor-pointer">
              ...
              <div className="flex gap-2">
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">Applied Deep Learning</span>
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">MLOps with Databricks</span>
              </div>
            </div>
            ...
            <div className="relative pl-6 border-l-2 border-transparent group cursor-pointer">
              ...
              <div className="flex gap-2">
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">System Design Masterclass</span>
                <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">YMP Leadership</span>
              </div>
            </div>
