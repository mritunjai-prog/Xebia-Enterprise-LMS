    ...
    <div className="min-h-screen bg-background text-gray-900 dark:text-gray-100 p-6 md:p-8 font-sans transition-colors duration-300 space-y-6 pb-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] flex flex-col justify-between h-full">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Trainer Rating</p>
            <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">4.9<span className="text-lg text-gray-400">/5</span></h4>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] flex flex-col justify-between h-full">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Session Rating</p>
            <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">4.6<span className="text-lg text-gray-400">/5</span></h4>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="bg-white dark:bg-[#111111] rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden flex flex-col transition-all duration-300 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] hover:-translate-y-1 group">
          <div className="p-6 border-b border-gray-200 dark:border-white/10 flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900 dark:text-white">Best Rated Trainings</h3>
          </div>
          <div className="flex-1 divide-y divide-gray-100 dark:divide-white/5 flex flex-col">
            ...
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="truncate">
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">Generative AI for PMs</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider truncate mt-1">Tech & Innovation</p>
                </div>
              </div>
              <div className="text-right shrink-0 ml-4">
                <p className="text-lg font-black text-[#6C1D5F] dark:text-[#FFACE8]">4.95</p>
                <p className="text-[10px] font-black text-[#01AC9F] uppercase tracking-wider mt-0.5">Top 1%</p>
              </div>
            </div>
            ...
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="truncate">
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">Servant Leadership 2.0</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider truncate mt-1">Leadership</p>
                </div>
              </div>
              <div className="text-right shrink-0 ml-4">
                <p className="text-lg font-black text-gray-900 dark:text-white">4.88</p>
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider mt-0.5">Top 5%</p>
              </div>
            </div>
            ...
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                ...
                <div className="truncate">
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">Advanced Python</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider truncate mt-1">Data Science</p>
                </div>
              </div>
              <div className="text-right shrink-0 ml-4">
                <p className="text-lg font-black text-gray-900 dark:text-white">4.85</p>
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider mt-0.5">Top 8%</p>
              </div>
            </div>
        ...
        <section className="bg-white dark:bg-[#111111] rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden flex flex-col transition-all duration-300 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] hover:-translate-y-1 group">
          <div className="p-6 border-b border-gray-200 dark:border-white/10 flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900 dark:text-white">Best Rated Trainers</h3>
          </div>
          <div className="flex-1 divide-y divide-gray-100 dark:divide-white/5 flex flex-col">
            
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4">
                <img className="w-12 h-12 rounded-full object-cover shadow-sm" src="https://i.pravatar.cc/150?u=helena" alt="Dr. Helena Thorne" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Dr. Helena Thorne</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider mt-1">Senior AI Consultant</p>
                </div>
              </div>
              <div className="text-right">
                ...
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider mt-0.5">120 Sessions</p>
              </div>
            </div>
            
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4">
                <img className="w-12 h-12 rounded-full object-cover shadow-sm" src="https://i.pravatar.cc/150?u=mark" alt="Mark J. Sterling" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Mark J. Sterling</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider mt-1">Executive Coach</p>
                </div>
              </div>
              <div className="text-right">
                ...
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider mt-0.5">85 Sessions</p>
              </div>
            </div>
            
            <div className="p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
              <div className="flex items-center gap-4">
                <img className="w-12 h-12 rounded-full object-cover shadow-sm" src="https://i.pravatar.cc/150?u=sophia" alt="Sophia Lin" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Sophia Lin</p>
                  <p className="text-[10px] font-black text-gray-500 uppercase tracking-wider mt-1">Lead Designer</p>
                </div>
              </div>
              <div className="text-right">
                <div className="flex items-center justify-end text-[#FF6200] font-black gap-1">
                ...
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-wider mt-0.5">42 Sessions</p>
              </div>
            </div>
        ...
        <section className="bg-white dark:bg-[#111111] rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden flex flex-col transition-all duration-300 hover:border-[#FF6200] dark:hover:border-[#FF6200] hover:-translate-y-1 group">
          <div className="p-6 border-b border-gray-200 dark:border-white/10 flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900 dark:text-white">Most Impactful Programs</h3>
          </div>
          <div className="flex-1 flex flex-col p-5 gap-4 justify-center">
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Data Literacy Wave</p>
                </div>
                <span className="text-xs font-black text-[#FF6200] px-2 py-1 bg-[#FF6200]/10 rounded shadow-sm">88% ROI</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Cloud Transformation</p>
                </div>
                <span className="text-xs font-black text-[#01AC9F] px-2 py-1 bg-[#01AC9F]/10 rounded shadow-sm">94% ADOPTION</span>
              </div>
              <div className="w-full bg-gray-100 dark:bg-white/5 h-2 rounded-full overflow-hidden shadow-inner">
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Future Leaders ‘24</p>
                </div>
                <span className="text-xs font-black text-[#6C1D5F] dark:text-[#FFACE8] px-2 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded shadow-sm">72% PROMOTION</span>
              </div>
              <div className="w-full bg-gray-100 dark:bg-white/5 h-2 rounded-full overflow-hidden shadow-inner">
                <div className="bg-[#6C1D5F] dark:bg-[#FFACE8] h-full rounded-full" style={{width: '72%'}}></div>
              </div>
            </div>
