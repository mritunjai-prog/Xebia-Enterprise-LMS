      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">TOTAL</span>
          </div>
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Total Certifications</p>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">TECH</span>
          </div>
          <div className="flex justify-between items-end">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">By Technology (Top)</p>
              <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">AWS <span className="text-lg text-gray-400">42%</span></h4>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] px-3 py-1 bg-[#FF6200]/10 rounded-lg">REGION</span>
          </div>
          <div className="flex justify-between items-end">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">By Region (Top)</p>
              <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">NA <span className="text-lg text-gray-400">38%</span></h4>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">PROJECT</span>
          </div>
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Active Cert Projects</p>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">GRADE</span>
          </div>
          <div className="flex justify-between items-end">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">By Grade (Top)</p>
              <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">L3 <span className="text-lg text-gray-400">28%</span></h4>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-span-12 bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">Certification Funnel</h3>
            </div>
            <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">LIFECYCLE</span>
          </div>
      ...
      <section className="bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">High Demand Certifications</h3>
              <p className="text-xs font-medium text-gray-500 mt-1">Top certifications driving enterprise capability</p>
            </div>
          </div>
          ...
          <table className="w-full text-left min-w-[800px]">
            <thead>
              <tr className="border-b border-gray-200 dark:border-white/10">
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Certification Focus</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Demand Level</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Enrolments</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Success Rate</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Status</th>
              </tr>
            </thead>
            <tbody className="text-sm">
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <div className="w-32 h-1.5 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="bg-[#6C1D5F] h-full rounded-full" style={{width: '95%'}}></div>
                  </div>
                </td>
                <td className="p-2 font-black text-gray-900 dark:text-white">245</td>
                <td className="p-2 font-black text-[#01AC9F]">88%</td>
                <td className="p-2">
                  <span className="px-2 py-1 bg-[#6C1D5F]/10 text-[#6C1D5F] dark:text-[#FFACE8] rounded text-[10px] font-black uppercase tracking-wider">CRITICAL</span>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <div className="w-32 h-1.5 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="bg-[#01AC9F] h-full rounded-full" style={{width: '85%'}}></div>
                  </div>
                </td>
                <td className="p-2 font-black text-gray-900 dark:text-white">189</td>
                <td className="p-2 font-black text-[#01AC9F]">82%</td>
                <td className="p-2">
                  <span className="px-2 py-1 bg-[#01AC9F]/10 text-[#01AC9F] rounded text-[10px] font-black uppercase tracking-wider">HIGH</span>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <div className="w-32 h-1.5 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="bg-[#FF6200] h-full rounded-full" style={{width: '78%'}}></div>
                  </div>
                </td>
                <td className="p-2 font-black text-gray-900 dark:text-white">142</td>
                <td className="p-2 font-black text-[#01AC9F]">79%</td>
                <td className="p-2">
                  <span className="px-2 py-1 bg-[#FF6200]/10 text-[#FF6200] rounded text-[10px] font-black uppercase tracking-wider">HIGH</span>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <span className="px-2 py-1 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded text-[10px] font-black uppercase tracking-wider">STABLE</span>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <div className="w-32 h-1.5 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="bg-[#01AC9F] h-full rounded-full" style={{width: '55%'}}></div>
                  </div>
                </td>
                <td className="p-2 font-black text-gray-900 dark:text-white">72</td>
                <td className="p-2 font-black text-[#01AC9F]">91%</td>
                <td className="p-2">
                  <span className="px-2 py-1 bg-[#01AC9F]/10 text-[#01AC9F] rounded text-[10px] font-black uppercase tracking-wider">GROWING</span>
                </td>
              </tr>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2">
                  <div className="w-32 h-1.5 bg-gray-100 dark:bg-white/10 rounded-full overflow-hidden">
                    <div className="bg-[#6C1D5F] h-full rounded-full" style={{width: '45%'}}></div>
                  </div>
                </td>
                <td className="p-2 font-black text-gray-900 dark:text-white">64</td>
                <td className="p-2 font-black text-[#01AC9F]">74%</td>
                <td className="p-2">
                  <span className="px-2 py-1 bg-[#6C1D5F]/10 text-[#6C1D5F] dark:text-[#FFACE8] rounded text-[10px] font-black uppercase tracking-wider">STABLE</span>
                </td>
              </tr>
