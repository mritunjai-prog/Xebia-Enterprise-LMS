    ...
    <div className="min-h-screen bg-background text-gray-900 dark:text-gray-100 p-6 md:p-8 font-sans transition-colors duration-300 space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        {kpiData.map((kpi) => (
          <div
            key={kpi.id}
            className={`relative overflow-hidden rounded-2xl p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 transition-all duration-300 hover:-translate-y-1 group ${kpi.hoverBorderClass}`}
          >
            ...
            <div
              className={`relative z-10 mt-4 text-xs font-bold flex items-center gap-1.5 ${kpi.colorClass}`}
            >
              {kpi.trend}
        ...
        {[
          {
            ...
            colorHex: "#6C1D5F",
            hoverBorderClass: "hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]",
            bgLight: "bg-[#6C1D5F]/10",
            bgDark: "dark:bg-[#FFACE8]/10",
            textLight: "text-[#6C1D5F]",
            textDark: "dark:text-[#FFACE8]",
            metric1Label: "Completion Rate",
            metric1Value: "98%",
            metric2Label: "Enrolled",
            metric2Value: "12,400",
            metric3Label: "Compliance Score",
            metric3Value: "99.2",
            progress: "98%",
          },
          {
            ...
            colorHex: "#01AC9F",
            hoverBorderClass: "hover:border-[#01AC9F] dark:hover:border-[#01AC9F]",
            bgLight: "bg-[#01AC9F]/10",
            bgDark: "dark:bg-[#01AC9F]/10",
            textLight: "text-[#01AC9F]",
            textDark: "dark:text-[#01AC9F]",
            metric1Label: "Skill Progress",
            metric1Value: "74%",
            metric2Label: "Active Learners",
            metric2Value: "8,230",
            metric3Label: "Certifications",
            metric3Value: "1,450",
            progress: "74%",
          },
          {
            ...
            tag: "STRATEGIC",
            examples:
              "Kiro, Claude, Copilot, GenAI Learning Paths, Prompt Engineering, AI Workshops.",
            icon: Brain,
            colorHex: "#6C1D5F",
            hoverBorderClass: "hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]",
            bgLight: "bg-[#6C1D5F]/10",
            ...
            textLight: "text-[#6C1D5F]",
            textDark: "dark:text-[#FFACE8]",
            metric1Label: "AI Readiness Score",
            metric1Value: "82%",
            metric2Label: "AI Adoption",
            metric2Value: "65%",
            metric3Label: "Tool Usage Hrs",
            metric3Value: "45.2K",
            progress: "82%",
          },
          {
            ...
            textLight: "text-[#01AC9F]",
            textDark: "dark:text-[#01AC9F]",
            metric1Label: "Pipeline Readiness",
            metric1Value: "78%",
            metric2Label: "Cohort Size",
            metric2Value: "1,200",
            metric3Label: "Promotion Rate",
            metric3Value: "24%",
            progress: "78%",
          },
          {
            ...
            tag: "GROWTH",
            examples:
              "Solution Architect Programs, Tech Lead Development Programs, Career Transition Programs.",
            icon: TrendingUp,
            colorHex: "#FF6200",
            hoverBorderClass: "hover:border-[#FF6200] dark:hover:border-[#FF6200]",
            bgLight: "bg-[#FF6200]/10",
            bgDark: "dark:bg-[#FF6200]/10",
            textLight: "text-[#FF6200]",
            textDark: "dark:text-[#FF6200]",
            metric1Label: "Skill Shift Rate",
            metric1Value: "85%",
            metric2Label: "Trainees",
            metric2Value: "3,400",
            metric3Label: "Placements",
            metric3Value: "2,800",
            progress: "85%",
          },
          {
            ...
            metric1Value: "92%",
            metric2Label: "Vouchers Used",
            metric2Value: "4,100",
            metric3Label: "Total Certified",
            metric3Value: "3,850",
            progress: "92%",
          },
          {
            ...
            textLight: "text-[#6C1D5F]",
            textDark: "dark:text-[#FFACE8]",
            metric1Label: "Engagement Rate",
            metric1Value: "88%",
            metric2Label: "Participants",
            metric2Value: "9,500",
            metric3Label: "Impact Score",
            metric3Value: "4.8",
            progress: "88%",
            isFullWidth: true,
          },
          ...
          <div
            key={pillar.id}
            className={`bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 group flex flex-col ${pillar.hoverBorderClass} ${pillar.isFullWidth ? "md:col-span-2 lg:col-span-3" : ""}`}
          >
            <div className="flex justify-between items-start mb-6">
              <div
                className={`p-3 ${pillar.bgLight} ${pillar.bgDark} ${pillar.textLight} ${pillar.textDark} rounded-xl`}
              >
                <pillar.icon className="w-6 h-6" />
              </div>
              <span
                className={`text-[10px] font-black uppercase tracking-wider ${pillar.textLight} ${pillar.textDark} px-3 py-1 ${pillar.bgLight} ${pillar.bgDark} rounded-lg`}
              >
                {pillar.tag}
              </span>
            </div>
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-6 flex-1 min-h-[40px]">
              {pillar.examples}
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-100 dark:bg-white/5 h-1.5 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: pillar.progress, backgroundColor: pillar.colorHex }}
                  ></div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
                ...
                <div>
                  ...
                  <p className={`text-lg font-black ${pillar.textLight} ${pillar.textDark}`}>
                    {pillar.metric3Value}
                  </p>
                </div>
              </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-xs font-medium text-gray-500">
                Learning category vs Technology focus
              </p>
            </div>
          </div>
      ...
      <div className="mt-8 bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors duration-300">
        <div className="p-6 border-b border-gray-200 dark:border-white/10 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs font-medium text-gray-500">
              Based on cross-pillar learning metrics
            </p>
          </div>
          <button className="text-xs font-bold text-[#6C1D5F] dark:text-[#FFACE8] hover:underline">
            View All
          </button>
        </div>
                ...
                >
                  <td className="p-4 pl-6">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-gray-900 dark:text-white group-hover:text-[#6C1D5F] dark:group-hover:text-[#FFACE8] transition-colors">
                        {row.team}
                      </span>
                    </div>
                  </td>
                    ...
                    <span
                      className={clsx(
                        ...
                        row.status === "Excellent"
                          ? "bg-[#01AC9F]/10 text-[#01AC9F] dark:bg-[#01AC9F]/20 dark:text-[#01AC9F]/80"
                          : "bg-[#6C1D5F]/10 text-[#6C1D5F] dark:bg-[#6C1D5F]/20 dark:text-[#6C1D5F]/80",
                      )}
                    >
                      {row.status}
                    </span>
