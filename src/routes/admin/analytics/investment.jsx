        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] flex flex-col justify-between h-full group">
          ...
          <div>
            ...
            <h4 className="text-3xl font-black text-gray-900 dark:text-white mt-1">
              14.2<span className="text-xl text-gray-400">k</span>
            </h4>
          </div>
        </div>
          ...
          <table className="w-full text-left min-w-[1000px]">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-white/10">
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                ...
                <td className="px-6 py-5 text-base font-black text-[#6C1D5F] dark:text-[#FFACE8]">
                  4,820<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-1.5">
                    <span className="text-base font-black text-gray-900 dark:text-white">124</span>
                    <span className="px-1.5 py-0.5 bg-[#01AC9F]/10 text-[#01AC9F] text-[9px] rounded font-black border border-[#01AC9F]/20">
                      TOP 5%
                    </span>
                  </div>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3 w-32">
                    ...
                    <span className="text-sm font-black text-[#6C1D5F] dark:text-[#FFACE8]">
                      88
                    </span>
                  </div>
                </td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                ...
                <td className="px-6 py-5 text-base font-black text-[#6C1D5F] dark:text-[#FFACE8]">
                  2,910<span className="text-xs text-gray-400">h</span>
                </td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                ...
                <td className="px-6 py-5 text-base font-black text-[#6C1D5F] dark:text-[#FFACE8]">
                  3,200<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5 text-base font-black text-gray-900 dark:text-white">
                  156
                </td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                ...
                <td className="px-6 py-5 text-base font-black text-[#6C1D5F] dark:text-[#FFACE8]">
                  1,840<span className="text-xs text-gray-400">h</span>
                </td>
