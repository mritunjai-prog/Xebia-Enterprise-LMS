        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-6 flex flex-col transition-all duration-300 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Certification Forecast (Q3/Q4)</h3>
            </div>
          </div>
          
          <div className="flex-1 flex flex-col justify-center space-y-6">
            <div className="text-center pb-4 border-b border-gray-100 dark:border-white/10">
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Predicted Completions</p>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center group">
                ...
                <span className="px-2 py-1 bg-[#01AC9F]/10 text-[#01AC9F] rounded text-xs font-bold">~420 Expected</span>
              </div>
              <div className="flex justify-between items-center group">
                <span className="text-sm font-bold text-gray-900 dark:text-white">Databricks Data Engineer</span>
                <span className="px-2 py-1 bg-[#6C1D5F]/10 text-[#6C1D5F] dark:text-[#FFACE8] rounded text-xs font-bold">~380 Expected</span>
              </div>
              <div className="flex justify-between items-center group">
                <span className="text-sm font-bold text-gray-900 dark:text-white">Azure Solutions</span>
                <span className="px-2 py-1 bg-[#FF6200]/10 text-[#FF6200] rounded text-xs font-bold">~310 Expected</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-6 flex flex-col transition-all duration-300 hover:border-[#01AC9F] dark:hover:border-[#01AC9F]">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">AI Readiness Forecast</h3>
            </div>
          </div>

          <div className="flex-1 flex flex-col justify-center space-y-6">
            <div className="text-center pb-4 border-b border-gray-100 dark:border-white/10">
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Projected Readiness by Q4</p>
        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm p-6 flex flex-col transition-all duration-300 hover:border-[#FF6200] dark:hover:border-[#FF6200]">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Learning Risk Indicators</h3>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col space-y-4">
            ...
            <div className="p-4 border-l-4 border-l-[#FF6200] bg-[#FF6200]/5 dark:bg-[#FF6200]/10 rounded-r-xl group">
              <div className="flex justify-between items-start mb-1">
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">High Dropout Risk Cohort</h4>
                <span className="text-[10px] font-black uppercase text-[#FF6200]">92% Probability</span>
              </div>
              <p className="text-xs text-gray-500">"Data Science Fundamentals" cohort showing steep engagement drop at module 4. Intervention recommended.</p>
            </div>

            <div className="p-4 border-l-4 border-l-[#6C1D5F] bg-[#6C1D5F]/5 dark:bg-[#FFACE8]/10 rounded-r-xl group">
              <div className="flex justify-between items-start mb-1">
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">Certification Expiry Cliff</h4>
                <span className="text-[10px] font-black uppercase text-[#6C1D5F] dark:text-[#FFACE8]">Upcoming</span>
              </div>
              <p className="text-xs text-gray-500">140 AWS Architect certifications expiring in the next 45 days. Recertification campaign required.</p>
            </div>

            <div className="p-4 border-l-4 border-l-gray-400 bg-gray-50 dark:bg-white/5 rounded-r-xl group">
              <div className="flex justify-between items-start mb-1">
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">Underutilized Licenses</h4>
                <span className="text-[10px] font-black uppercase text-gray-500">Low Risk</span>
              </div>
              <p className="text-xs text-gray-500">Udemy Business licenses running 15% below optimal utilization in the Consulting BU.</p>
            </div>
