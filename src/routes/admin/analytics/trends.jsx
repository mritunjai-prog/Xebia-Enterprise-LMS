      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">VOLUME</span>
          </div>
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Sessions Conducted</p>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">REACH</span>
          </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between h-full">
          ...
          <div className="flex justify-between items-end">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Certs Achieved</p>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between h-full relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-white px-3 py-1 bg-[#01AC9F] rounded-lg shadow-sm animate-pulse">TRENDING</span>
            </div>
            <div className="flex justify-between items-end">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">AI Learning Growth</p>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <section className="bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-black text-gray-900 dark:text-white">Growth Trends Over Time</h3>
                <p className="text-xs font-medium text-gray-500 mt-1">Performance visualization across {activeView} periods</p>
              </div>
            </div>
            <div className="flex gap-4 items-center">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-[#6C1D5F] shadow-sm"></span>
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-500">Employees Trained</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-[#01AC9F] shadow-sm"></span>
                <span className="text-[10px] font-black uppercase tracking-wider text-gray-500">Certifications</span>
              </div>
            </div>
          </div>
          ...
          <div className="h-[380px] relative w-full flex items-end">
            ...
            <div className="relative w-full h-full px-4 pt-8 pb-10">
              <svg className="w-full h-full drop-shadow-xl" preserveAspectRatio="none" viewBox="0 0 1000 300">
                ...
                <path className="animate-[dash_2s_ease-out_forwards]" d="M0,250 L100,220 L200,240 L300,180 L400,190 L500,120 L600,140 L700,80 L800,100 L900,40 L1000,20" fill="none" stroke="#6C1D5F" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"></path>
                {/* Certifications Line (Secondary) */}
                <path className="animate-[dash_2.5s_ease-out_forwards] opacity-90" d="M0,280 L100,270 L200,260 L300,240 L400,220 L500,230 L600,190 L700,210 L800,150 L900,170 L1000,110" fill="none" stroke="#01AC9F" strokeDasharray="10,6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"></path>
              </svg>
              {/* X-Axis Labels */}
              <div className="absolute bottom-2 left-4 right-4 flex justify-between text-[10px] text-gray-400 font-black tracking-wider">
                {activeView === 'MoM' ? (
                  ...
                  <><span>Q1 2024</span><span>Q2 2024</span><span>Q3 2024</span><span>Q4 2024</span><span>Q1 2025</span><span>Q2 2025</span><span>Q3 2025</span><span>Q4 2025</span></>
                ) : (
        ...
        <section>
          <div className="flex items-center gap-3 mb-6 px-1">
            ...
            <h3 className="text-xl font-black text-gray-900 dark:text-white">Growth Indicators ({activeView})</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-gray-500 mb-1">Training Growth %</p>
            ...
            <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all hover:border-[#01AC9F] dark:hover:border-[#01AC9F] hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-gray-500 mb-1">Learner Growth %</p>
                  <h4 className="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-2">
                    +24.2%
                  </h4>
                </div>
            ...
            <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] hover:-translate-y-1">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-gray-500 mb-1">Certification Growth %</p>
                  <h4 className="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-2">
                    +12.8%
                  </h4>
                </div>
            ...
            <div className="bg-white dark:bg-[#111111] border border-[#FF6200]/20 rounded-2xl p-6 shadow-sm transition-all hover:border-[#FF6200] dark:hover:border-[#FF6200] hover:-translate-y-1 relative overflow-hidden">
              <div className="flex justify-between items-start relative z-10">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] mb-1">AI Adoption Growth %</p>
                  <h4 className="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-2">
                    +142.0%
                  </h4>
                </div>
              ...
              <p className="text-xs font-black text-[#FF6200] mt-2 relative z-10">Hyper-Growth Phase</p>
            </div>
