      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-8">
        ...
        <div className="col-span-1 xl:col-span-4 bg-white dark:bg-[#111111] rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between relative overflow-hidden h-full">
          ...
          <div className="flex items-start justify-between relative z-10 mb-6">
            <div>
              <p className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] mb-3">AI Maturity Score</p>
            ...
            <div className="w-32 h-32 relative transition-transform duration-500 hidden sm:block">
              <svg className="w-full h-full transform -rotate-90 drop-shadow-xl" viewBox="0 0 36 36">
                <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" className="text-gray-100 dark:text-white/5" strokeWidth="3"></path>
                <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#6C1D5F" strokeDasharray="78.4, 100" strokeLinecap="round" strokeWidth="3"></path>
              </svg>
          ...
          <div className="relative z-10 pt-4 border-t border-gray-200 dark:border-white/10">
            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2">Score Components</p>
            <div className="flex flex-wrap gap-2">
              <span className="px-2 py-1 bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">Training Completion</span>
              <span className="px-2 py-1 bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">Certification Achievement</span>
              <span className="px-2 py-1 bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">Tool Adoption</span>
              <span className="px-2 py-1 bg-gray-100 dark:bg-white/5 text-gray-600 dark:text-gray-300 rounded text-[10px] font-bold">AI Learning Hours</span>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:col-span-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">CORE</span>
            </div>
            <div>
          ...
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">ACHIEVEMENT</span>
            </div>
            <div>
          ...
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] group flex flex-col justify-between">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] px-3 py-1 bg-[#FF6200]/10 rounded-lg">ENGAGEMENT</span>
            </div>
            <div>
          ...
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] group flex flex-col justify-between">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">PROGRAMS</span>
            </div>
            <div>
          ...
          <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] group flex flex-col justify-between h-full">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] px-3 py-1 bg-[#FF6200]/10 rounded-lg">RETENTION</span>
            </div>
        ...
        <div className="col-span-12 lg:col-span-4 bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group flex flex-col justify-between h-full">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">AI Adoption Funnel</h3>
            </div>
            <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] px-3 py-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 rounded-lg">LIVE DATA</span>
          </div>
          ...
          <div className="col-span-12 lg:col-span-4 bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 relative overflow-hidden group hover:border-[#01AC9F] transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between h-full">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] px-3 py-1 bg-[#01AC9F]/10 rounded-lg">METRICS</span>
            </div>
          ...
          <div className="col-span-12 lg:col-span-4 bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] group flex flex-col justify-between h-full">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] px-3 py-1 bg-[#FF6200]/10 rounded-lg">PEOPLE</span>
            </div>
            ...
            <div className="space-y-4 mt-2">
              <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-white/10">
                <img className="w-10 h-10 rounded-full object-cover border-2 border-white dark:border-gray-800 shadow-sm" src="https://i.pravatar.cc/150?u=sarah" alt="Sarah Chen" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Sarah Chen</p>
                  <p className="text-[10px] text-[#6C1D5F] font-black uppercase tracking-wider bg-[#6C1D5F]/10 inline-block px-1.5 py-0.5 rounded mt-1">AI Power User</p>
                </div>
              </div>
              
              <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-white/10">
                <img className="w-10 h-10 rounded-full object-cover border-2 border-white dark:border-gray-800 shadow-sm" src="https://i.pravatar.cc/150?u=marcus" alt="Marcus Thorne" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Marcus Thorne</p>
                  <p className="text-[10px] text-[#01AC9F] font-black uppercase tracking-wider bg-[#01AC9F]/10 inline-block px-1.5 py-0.5 rounded mt-1">AI Mentor</p>
                </div>
              </div>
              
              <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-white/10">
                <img className="w-10 h-10 rounded-full object-cover border-2 border-white dark:border-gray-800 shadow-sm" src="https://i.pravatar.cc/150?u=elena" alt="Elena Rodriguez" />
                <div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Elena Rodriguez</p>
                  <p className="text-[10px] text-[#FF6200] font-black uppercase tracking-wider bg-[#FF6200]/10 inline-block px-1.5 py-0.5 rounded mt-1">AI Ambassador</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white dark:bg-[#111111] p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] group">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">AI Capability Heatmap</h3>
              <p className="text-xs font-medium text-gray-500 mt-1">Display AI readiness across multiple dimensions</p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-1 bg-gray-100 dark:bg-black/20 rounded-lg p-1 border border-gray-200 dark:border-white/5">
            <button className="px-4 py-2 text-[10px] font-black uppercase tracking-wider text-gray-500 hover:text-[#6C1D5F] dark:hover:text-white transition-colors">BY REGION</button>
            <button className="px-4 py-2 bg-white dark:bg-[#6C1D5F] shadow-sm rounded-md text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-white">BY DEPARTMENT</button>
            <button className="px-4 py-2 text-[10px] font-black uppercase tracking-wider text-gray-500 hover:text-[#6C1D5F] dark:hover:text-white transition-colors">BY PROJECT</button>
            <button className="px-4 py-2 text-[10px] font-black uppercase tracking-wider text-gray-500 hover:text-[#6C1D5F] dark:hover:text-white transition-colors">BY PRACTICE</button>
          </div>
        </div>
          ...
          <table className="w-full text-left min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-200 dark:border-white/10">
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400">Dimension</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">Engineering</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">Product</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">Marketing</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">Sales</th>
                <th className="pb-4 text-[10px] font-black uppercase tracking-wider text-gray-400 text-center">Ops</th>
              </tr>
            </thead>
            <tbody className="text-sm">
              <tr className="border-b border-gray-100 dark:border-white/5">
                <td className="py-4 font-bold text-gray-900 dark:text-white">North America</td>
                <td className="p-2"><div className="h-10 bg-[#6C1D5F] text-white flex items-center justify-center rounded-lg font-black shadow-sm transform hover:scale-105 transition-transform cursor-pointer">94%</div></td>
                <td className="p-2"><div className="h-10 bg-[#6C1D5F]/80 text-white flex items-center justify-center rounded-lg font-bold transform hover:scale-105 transition-transform cursor-pointer">82%</div></td>
                <td className="p-2"><div className="h-10 bg-[#6C1D5F]/40 text-gray-900 dark:text-white flex items-center justify-center rounded-lg font-medium transform hover:scale-105 transition-transform cursor-pointer">56%</div></td>
                <td className="p-2"><div className="h-10 bg-[#6C1D5F]/20 text-gray-700 dark:text-gray-300 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer">32%</div></td>
                <td className="p-2"><div className="h-10 bg-[#6C1D5F]/60 text-white flex items-center justify-center rounded-lg font-bold transform hover:scale-105 transition-transform cursor-pointer">61%</div></td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-white/5">
                <td className="py-4 font-bold text-gray-900 dark:text-white">EMEA</td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/90 text-white flex items-center justify-center rounded-lg font-black shadow-sm transform hover:scale-105 transition-transform cursor-pointer">88%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/70 text-white flex items-center justify-center rounded-lg font-bold transform hover:scale-105 transition-transform cursor-pointer">71%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/30 text-gray-800 dark:text-gray-200 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer">44%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/10 text-gray-600 dark:text-gray-400 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer border border-[#01AC9F]/20">18%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/40 text-gray-900 dark:text-white flex items-center justify-center rounded-lg font-medium transform hover:scale-105 transition-transform cursor-pointer">52%</div></td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-white/5">
                <td className="py-4 font-bold text-gray-900 dark:text-white">APAC</td>
                <td className="p-2"><div className="h-10 bg-[#FF6200] text-white flex items-center justify-center rounded-lg font-black shadow-sm transform hover:scale-105 transition-transform cursor-pointer ring-2 ring-[#FFACE8]/50 ring-offset-1 dark:ring-offset-black">98%</div></td>
                <td className="p-2"><div className="h-10 bg-[#FF6200]/85 text-white flex items-center justify-center rounded-lg font-black transform hover:scale-105 transition-transform cursor-pointer">85%</div></td>
                <td className="p-2"><div className="h-10 bg-[#FF6200]/50 text-white flex items-center justify-center rounded-lg font-medium transform hover:scale-105 transition-transform cursor-pointer">64%</div></td>
                <td className="p-2"><div className="h-10 bg-[#FF6200]/30 text-gray-800 dark:text-gray-200 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer">41%</div></td>
                <td className="p-2"><div className="h-10 bg-[#FF6200]/80 text-white flex items-center justify-center rounded-lg font-bold transform hover:scale-105 transition-transform cursor-pointer">79%</div></td>
              </tr>
              <tr>
                <td className="py-4 font-bold text-gray-900 dark:text-white">LATAM</td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/50 text-white flex items-center justify-center rounded-lg font-medium transform hover:scale-105 transition-transform cursor-pointer">62%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/30 text-gray-800 dark:text-gray-200 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer">45%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/10 text-gray-600 dark:text-gray-400 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer border border-[#01AC9F]/20">21%</div></td>
                <td className="p-2"><div className="h-10 bg-transparent text-gray-500 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer border border-dashed border-gray-300 dark:border-gray-700">9%</div></td>
                <td className="p-2"><div className="h-10 bg-[#01AC9F]/20 text-gray-700 dark:text-gray-300 flex items-center justify-center rounded-lg text-xs transform hover:scale-105 transition-transform cursor-pointer">34%</div></td>
              </tr>
            </tbody>
          </table>
        </div>
