          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">
                Strategic Programs Tracking
              </h3>
              <p className="text-xs font-medium text-gray-500 mt-1">
                Detailed performance metrics for all flagship initiatives
              </p>
            </div>
          </div>
        </div>
          ...
          <table className="w-full text-left min-w-[900px]">
            ...
            <tbody className="text-sm">
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="py-5 font-bold text-gray-900 dark:text-white group-hover:text-[#6C1D5F] dark:group-hover:text-[#FFACE8] transition-colors">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8] mt-1 bg-[#6C1D5F]/10 dark:bg-[#FFACE8]/10 w-fit px-1.5 py-0.5 rounded">
                      Leadership
                    </span>
                  </div>
                </td>
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">420</td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="py-5 font-bold text-gray-900 dark:text-white group-hover:text-[#01AC9F] transition-colors">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F] mt-1 bg-[#01AC9F]/10 w-fit px-1.5 py-0.5 rounded">
                      Technology
                    </span>
                  </div>
                </td>
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">190</td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="py-5 font-bold text-gray-900 dark:text-white group-hover:text-[#FF6200] transition-colors">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200] mt-1 bg-[#FF6200]/10 w-fit px-1.5 py-0.5 rounded">
                      Innovation
                    </span>
                  </div>
                </td>
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">1,200</td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">492</td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="py-5 font-bold text-gray-900 dark:text-white group-hover:text-[#01AC9F] transition-colors">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-wider text-gray-500 mt-1 bg-gray-100 dark:bg-white/10 w-fit px-1.5 py-0.5 rounded">
                      Certification
                    </span>
                  </div>
                </td>
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">1,840</td>
              </tr>
              ...
              <tr className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">84</td>
              </tr>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="p-2 text-center font-black text-gray-900 dark:text-white">4,100</td>
              </tr>
            </tbody>
          </table>
        </div>
