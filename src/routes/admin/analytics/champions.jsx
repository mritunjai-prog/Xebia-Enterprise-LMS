        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] flex flex-col justify-between group relative overflow-hidden h-[240px]">
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F]">
          ...
          <div className="flex items-center gap-4 relative z-10">
            <img
              className="w-16 h-16 rounded-full object-cover border-2 border-[#6C1D5F] shadow-sm"
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10 relative z-10">
            <p className="text-sm font-bold text-gray-700 dark:text-gray-300">
              Consistently pushing boundaries in Cloud adoption.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#FF6200] dark:hover:border-[#FF6200] flex flex-col justify-between group relative overflow-hidden h-[240px]">
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#FF6200]">
                Top AI Learner
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 relative z-10">
            <img
              className="w-16 h-16 rounded-full object-cover border-2 border-[#FF6200] shadow-sm"
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10 relative z-10">
            <p className="text-sm font-bold text-gray-700 dark:text-gray-300">
              Mastered 12 Generative AI modules this quarter.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#01AC9F] dark:hover:border-[#01AC9F] flex flex-col justify-between group relative overflow-hidden h-[240px]">
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#01AC9F]">
                Top Certified
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 relative z-10">
            <img
              className="w-16 h-16 rounded-full object-cover border-2 border-[#01AC9F] shadow-sm"
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10 relative z-10">
            <p className="text-sm font-bold text-gray-700 dark:text-gray-300">
              Achieved GCP Pro & Azure Architect in Q2.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] flex flex-col justify-between group relative overflow-hidden h-[240px]">
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider text-[#6C1D5F] dark:text-[#FFACE8]">
                Learning Champion
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 relative z-10">
            <img
              className="w-16 h-16 rounded-full object-cover border-2 border-[#6C1D5F] dark:border-[#FFACE8] shadow-sm"
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-white/10 relative z-10">
            <p className="text-sm font-bold text-gray-700 dark:text-gray-300">
              Highest active participation & community mentoring.
            </p>
          </div>
        </div>
      </div>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-white/10">
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="px-6 py-5">
                  <div className="w-10 h-10 rounded-full bg-[#6C1D5F]/10 text-[#6C1D5F] flex items-center justify-center font-black text-sm border border-[#6C1D5F]/20 shadow-sm">
                    01
                  </div>
                </td>
                <td className="px-6 py-5">
                ...
                <td className="px-6 py-5 text-base font-black text-gray-900 dark:text-white">
                  142.5<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5">
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                <td className="px-6 py-5">
                  <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 flex items-center justify-center font-black text-sm border border-gray-200 dark:border-white/20 shadow-sm">
                    02
                  </div>
                </td>
                <td className="px-6 py-5">
                ...
                <td className="px-6 py-5 text-base font-black text-gray-900 dark:text-white">
                  128.0<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-1.5">
                    <CheckCircle2 className="w-5 h-5 text-[#01AC9F]" />
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="px-6 py-5 text-base font-black text-gray-900 dark:text-white">
                  119.2<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-1.5">
                    <CheckCircle2 className="w-5 h-5 text-[#01AC9F]" />
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                ...
                <td className="px-6 py-5 text-base font-black text-gray-900 dark:text-white">
                  104.5<span className="text-xs text-gray-400">h</span>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-1.5">
                    <CheckCircle2 className="w-5 h-5 text-[#01AC9F]" />
