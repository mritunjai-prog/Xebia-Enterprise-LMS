...
export const CourseService = {
  ...
  updateModule: (moduleId, data) => fetchApi(`/courses/modules/${moduleId}`, { method: 'PUT', body: JSON.stringify(data) }),
  ...
  updateSubmodule: (submoduleId, data) => fetchApi(`/courses/submodules/${submoduleId}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteSubmodule: (submoduleId) => fetchApi(`/courses/submodules/${submoduleId}`, { method: 'DELETE' }),
