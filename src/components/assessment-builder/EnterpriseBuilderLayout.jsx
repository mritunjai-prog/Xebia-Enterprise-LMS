              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-6">
                <div className="bg-neutral-50 dark:bg-neutral-950/50 p-4 rounded-2xl border border-neutral-200 dark:border-neutral-800">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div><span className="block text-[10px] font-bold text-neutral-500 uppercase tracking-wider">Total Marks</span><span className="font-mono font-bold text-[#6C1D5F] dark:text-primary">{questions.reduce((acc, q) => acc + (q.marks || 0), 0)}</span></div>
                    <div><span className="block text-[10px] font-bold text-neutral-500 uppercase tracking-wider">Status</span><span className="font-bold text-destructive">Draft</span></div>
                  </div>
                </div>

                <div>
                  <h4 className="text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-3 flex items-center gap-2">
                    <CheckSquare className="w-4 h-4 text-accent-2" /> Questions Preview ({questions.length})
                  </h4>
                  {questions.length === 0 ? (
