  ...
  return (
    <div className="w-[320px] shrink-0 bg-white dark:bg-neutral-900 border-l border-neutral-200 dark:border-neutral-800 flex flex-col h-full">
      ...
      <div className="flex border-b border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 p-2 gap-2 sticky top-0">
        <div className="flex-1 py-2 px-3 bg-white dark:bg-neutral-900 rounded-xl shadow-sm text-xs font-bold text-[#6C1D5F] dark:text-primary border border-neutral-200 dark:border-neutral-800 flex items-center justify-center gap-1.5">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6">
        ...
        <div className="flex flex-col items-center">
          <div
            className={`transition-all duration-300 border-2 border-neutral-200 dark:border-neutral-800 rounded-3xl overflow-hidden bg-neutral-50 dark:bg-[#0a0a0a] shadow-inner relative flex flex-col ${device === "mobile" ? "w-[280px] h-[550px]" : device === "tablet" ? "w-[360px] h-[550px]" : "w-full h-[350px]"}`}
          >
            {/* Fake Browser Chrome */}
                      ...
                      {(q.type === "mcq" || q.type === "true_false") && q.options && (
                        <div className="space-y-2">
                          {q.options.map((opt, oIdx) => (
                            <div
                              key={oIdx}
                              className="flex items-center gap-2 p-2 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-xs text-neutral-600 dark:text-neutral-300"
                            >
          ...
          <p className="text-[10px] text-neutral-400 mt-3 font-bold uppercase tracking-wider text-center">
