      ...
      <div className="container mx-auto px-6 max-w-7xl mb-20">
        <div className="relative bg-[#2C0B27] dark:bg-[#1A0517] rounded-3xl p-10 md:p-14 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
          ...
          <div className="absolute inset-0 opacity-20 pointer-events-none">
            <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1440 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 100C320 200 480 0 720 100C960 200 1120 0 1440 100V200H0V100Z" fill="url(#paint0_linear)"/>
              <defs>
          ...
          <div className="flex items-center gap-6 relative z-10">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm md:text-base max-w-xl">
                Join thousands of organizations empowering their workforce with Xebia Enterprise LMS.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <Link to="/" className="inline-block mb-6">
              <img src={isDark ? logoWhite : logoPurple} alt="Xebia LMS" className="h-8 object-contain" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Features', 'Pricing', 'Integrations', 'Updates'].map(link => (
                <li key={link}>
                  <a href="#" className="text-sm text-gray-500 dark:text-gray-400 hover:text-[#6C1D5F] dark:hover:text-[#FFACE8] transition-colors">{link}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <div className="flex gap-4 mb-6">
              {[Globe, Mail, MessageSquare, Phone].map((Icon, i) => (
                <a key={i} href="#" className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-[#6C1D5F] dark:text-[#FFACE8] hover:bg-[#6C1D5F] hover:text-white dark:hover:bg-[#FFACE8] dark:hover:text-gray-900 transition-colors">
