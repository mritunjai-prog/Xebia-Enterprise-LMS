...
const portals = [
  {
    ...
    description: "Access your courses, track progress, attend assessments, earn certifications, and enhance your skills.",
    icon: GraduationCap,
  ...
  },
  {
    id: "admin",
    title: "Admin Portal",
    description: "The central hub for architects and executives. Generate courses via AI, manage complex curriculums, and analyze predictive workforce data.",
    icon: ShieldCheck,
    bgClass: "bg-[#01AC9F]",
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {portals.map((portal) => (
            ...
            >
              <div className="mb-8">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-lg ${portal.bgClass} text-white`}>
              ...
              <div className="flex-1 space-y-4 mb-10">
                {portal.features.map((feature, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 text-sm font-semibold">{feature}</span>
                  </div>
                ))}
              </div>
