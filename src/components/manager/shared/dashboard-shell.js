          ...
          children: [
            ...
            _jsx("div", {
              ...
              children: _jsx(SidebarTrigger, {
                className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-[#6C1D5F] shadow-sm border border-[#EDEDED] transition-all hover:bg-[#6C1D5F]/5 hover:text-[#4A1E47]",
              }),
            }),
            /* Main content area */
            _jsx("div", {
