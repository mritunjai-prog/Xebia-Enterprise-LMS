...
const KpiCard = ({ title, mainValue, mainLabel, icon: Icon, colorClass, gradientClass, hoverBorderClass, metrics }) => (
  <div className={`relative overflow-hidden rounded-2xl p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/10 transition-all duration-300 hover:-translate-y-1 group ${hoverBorderClass || 'hover:border-[#6C1D5F] dark:hover:border-[#FFACE8]'} ${gradientClass}`}>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-8">
      ...
      <KpiCard 
        ...
        metrics={[
          { label: "Certification Growth %", value: "24%", trend: "5%" }
        ]}
      />
