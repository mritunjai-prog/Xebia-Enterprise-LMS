...
export function HoursLeaderboards() {
  const topProjects = [
    { rank: 1, name: "AI-First Engineering Transformation", hours: "24,500", avg: "56.4", completion: "94%", trend: "+12%" },
    { rank: 2, name: "Global Leadership Bootcamp 2024", hours: "18,200", avg: "42.1", completion: "88%", trend: "+8%" },
    { rank: 3, name: "Data Privacy & Ethics Certification", hours: "15,400", avg: "38.5", completion: "91%", trend: "+15%" },
    { rank: 4, name: "Cloud Native Architecture Mastery", hours: "12,100", avg: "34.2", completion: "85%", trend: "+5%" },
    { rank: 5, name: "Agile Delivery Professional", hours: "9,800", avg: "28.4", completion: "78%", trend: "-2%" }
  ];
  ...
  const topLearners = [
    { rank: 1, name: "Alex Chen", dept: "Engineering", project: "AI-First", hours: "212", progress: "100%", certs: 4, ai: 140 },
    { rank: 2, name: "Sarah Miller", dept: "Consulting", project: "Cloud Native", hours: "198", progress: "100%", certs: 3, ai: 85 },
    { rank: 3, name: "Marcus Johnson", dept: "Sales", project: "Leadership", hours: "185", progress: "95%", certs: 2, ai: 40 },
    { rank: 4, name: "Yuki Tanaka", dept: "Engineering", project: "Data Privacy", hours: "174", progress: "90%", certs: 3, ai: 60 },
    { rank: 5, name: "Elena Rodriguez", dept: "Operations", project: "Agile", hours: "162", progress: "88%", certs: 1, ai: 20 }
  ];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors duration-300 shadow-sm overflow-hidden flex flex-col h-[450px]">
        <div className="p-5 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/10 flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">Top 10 Projects</h3>
        </div>
          ...
          {topProjects.map((item, idx) => (
            <div key={idx} className="flex flex-col gap-2 p-3 rounded-xl border border-gray-100 dark:border-white/5 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors group">
              <div className="flex items-center justify-between">
                ...
                <span className="font-black text-[#6C1D5F] dark:text-[#FFACE8] text-sm">{item.hours}h</span>
              </div>
      ...
      <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors duration-300 shadow-sm overflow-hidden flex flex-col h-[450px]">
        <div className="p-5 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/10 flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">Top 10 Regions</h3>
        </div>
        <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-4">
          {topRegions.map((item, idx) => (
            <div key={idx} className="flex flex-col gap-2 p-3 rounded-xl border border-gray-100 dark:border-white/5 hover:border-[#01AC9F] transition-colors group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
      ...
      <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-white/10 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors duration-300 shadow-sm overflow-hidden flex flex-col h-[450px]">
        <div className="p-5 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/10 flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider">Top 10 Learners</h3>
        </div>
        <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-4">
            ...
            <div key={idx} className="flex gap-3 p-3 rounded-xl border border-gray-100 dark:border-white/5 hover:border-[#FF6200] transition-colors group">
              <div className="relative shrink-0">
                <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden border border-gray-300 dark:border-gray-700">
                  <img src={`https://i.pravatar.cc/150?u=${item.name.replace(/\s+/g, '')}`} alt={item.name} className="w-full h-full object-cover" />
                </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-[10px] uppercase tracking-wider text-gray-500 truncate">{item.dept}</span>
