  ...
  const activities = [
    {
      ...
      desc: "Sarah Miller completed Cloud Architecture Learning Path.",
      time: "10 mins ago",
      icon: Award,
      color: "text-[#01AC9F]",
      bg: "bg-[#01AC9F]/10",
    },
    {
      ...
      type: "alert",
      title: "Below Target",
      desc: "125 employees in Sales are below Q2 targets.",
      time: "1 hour ago",
      icon: AlertTriangle,
      color: "text-[#FF6200]",
      bg: "bg-[#FF6200]/10",
    },
    {
      ...
      desc: "Data Privacy Project reached 15,000 learning hours.",
      time: "3 hours ago",
      icon: PlayCircle,
      color: "text-[#6C1D5F]",
      bg: "bg-[#6C1D5F]/10",
    },
    {
      ...
      desc: "Engineering Department crossed Q2 learning target.",
      time: "5 hours ago",
      icon: CheckCircle2,
        ...
        <div className="space-y-4 flex-1">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-1">
                  Learning Investment Increased
                </h4>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  Learning investment increased by 18% this quarter. North America achieved the
                  highest average learning hours globally.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-[#FF6200]/5 border border-[#FF6200]/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900 dark:text-white mb-1">
                  Declining Hours Alert
                </h4>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  Cloud Native project saw a 10% drop in learning hours. Operations and HR require
                  additional learning investment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-[#01AC9F]/5 border border-[#01AC9F]/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  Schedule a dedicated learning sprint for the LATAM region to align their project
                  participation with engineering pods.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="col-span-1 lg:col-span-1 bg-white dark:bg-[#111111] p-6 rounded-2xl border border-gray-200 dark:border-white/10 hover:border-[#6C1D5F] dark:hover:border-[#FFACE8] transition-colors duration-300 h-full flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pr-2 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 dark:before:via-white/10 before:to-transparent">
          {activities.map((activity) => (
            <div
              key={activity.id}
              className="relative flex items-center mb-6 last:mb-0 pl-12 group"
            >
              <div
