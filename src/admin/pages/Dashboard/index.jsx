...
const LEVEL_COLORS = {
  Beginner: 'bg-accent-2/10 dark:bg-accent-2/10 text-accent-2 dark:text-accent-2 border-accent-2/20 dark:border-accent-2/20',
  Intermediate: 'bg-primary/10 dark:bg-primary/10 text-primary dark:text-primary border-primary/20 dark:border-primary/20',
  Advanced: 'bg-destructive/10 dark:bg-destructive/10 text-destructive dark:text-destructive border-destructive/20 dark:border-destructive/20',
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span className={`text-[11px] font-bold px-2.5 py-1 rounded-full ${
                        isPublished ? 'bg-accent-2/10 dark:bg-accent-2 text-accent-2' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'
                      }`}>
