...
import { BookOpen, Tag, CheckCircle, Clock, Plus, ArrowRight, GraduationCap, Users } from 'lucide-react';
...
const LEVEL_COLORS = {
  Beginner: 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-600/20 dark:border-emerald-500/20',
  Intermediate: 'bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-400 border-purple-600/20 dark:border-purple-500/20',
  Advanced: 'bg-orange-50 dark:bg-orange-500/10 text-orange-700 dark:text-orange-400 border-orange-600/20 dark:border-orange-500/20',
  Expert: 'bg-gray-100 dark:bg-gray-500/10 text-gray-800 dark:text-gray-300 border-gray-600/20 dark:border-gray-500/20',
};
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={idx} className="bg-white dark:bg-[#15151f] rounded-2xl border border-gray-200 dark:border-[#2e2e3e] p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">{kpi.label}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#15151f] rounded-2xl border border-gray-200 dark:border-[#2e2e3e] shadow-sm p-6 flex flex-col">
          ...
          {loading ? (
            ...
            <div className="py-12 text-center text-sm text-gray-400">No courses available. Create one to get started!</div>
          ) : (
                  ...
                  >
                    <div className="w-11 h-11 rounded-xl bg-[#6C1D5F]/10 text-[#6C1D5F] dark:text-[#84117C] flex items-center justify-center shrink-0 font-bold text-[13px] uppercase shadow-sm overflow-hidden relative">
                      ...
                      {(course.icon || course.thumbnailImageUrl || course.thumbnail) && (
                        <img src={course.icon || course.thumbnailImageUrl || course.thumbnail} alt="" className="w-full h-full object-contain p-1 relative z-10" onError={e => { e.target.style.display = 'none'; }} />
                      )}
                    </div>
                    <div className="flex-1 min-w-0 flex items-center gap-2">
                      ...
                      <span className={clsx('text-[10px] font-bold px-2 py-0.5 rounded-full border shrink-0', levelColor)}>
                        {level}
                      </span>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <span className={`text-[11px] font-bold px-2.5 py-1 rounded-full ${
                        isPublished ? 'bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'
                      }`}>
          ...
          <div className="space-y-3.5">
            ...
            >
              ...
              <div>
                ...
                <span className="text-[12px] text-gray-500 dark:text-gray-400 font-medium">Create course categories</span>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <span className="text-[12px] text-gray-500 dark:text-gray-400 font-medium">Add a course curriculum</span>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <span className="text-[12px] text-gray-500 dark:text-gray-400 font-medium">Manage learning schedules</span>
              </div>
            </Link>
          </div>
        </div>
