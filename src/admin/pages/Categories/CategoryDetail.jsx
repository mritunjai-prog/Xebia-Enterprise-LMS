  ...
  if (!category) {
    return (
      <div className="text-center py-16 bg-white dark:bg-[#151515] rounded-2xl border border-gray-200 dark:border-[#333]">
        ...
        <Link
          to="/admin/categories"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#6C1D5F] hover:bg-[#5a1850] text-white font-semibold rounded-xl text-sm transition-colors"
        >
    ...
    <div className="space-y-6 animate-in fade-in duration-200 pb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
            ...
            <div className="flex items-center justify-center shrink-0">
              ...
              !category.icon.startsWith("data:") ? (
                ...
                >
                  <span className="text-[200px] sm:text-[250px] leading-none absolute flex items-center justify-center w-full h-full">
                    {category.icon}
                  </span>
                </div>
              ) : category.icon ? (
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <span
                  className={`inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1 rounded-full text-white ${
                    category.active ? "bg-accent-2" : "bg-destructive"
                  }`}
                >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 font-semibold mt-3 uppercase tracking-wider">
            Total Courses
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === "Overview" && (
            <>
              ...
              >
                <h3 className="text-lg font-bold text-[#6C1D5F] dark:text-[#84117C] mb-5">
                  General Information
                </h3>

                <div className="grid grid-cols-1 gap-5 mb-5">
                  <div>
                    <span className="block text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-1">
                      Visibility
                    </span>
                ...
                <div className="pt-4 border-t border-gray-100 dark:border-[#222]">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                    {category.description ||
                      `This category encompasses all modules related to ${category.name}. Courses cover fundamental concepts as well as advanced topics, providing a comprehensive learning experience for enterprise teams.`}
                  </p>
                </div>
              </motion.div>
              ...
              >
                <h3 className="text-lg font-bold text-[#6C1D5F] dark:text-[#84117C] mb-4">
                  Enrollment Growth
                </h3>
              ...
              {courses.length === 0 ? (
                ...
                <div className="space-y-3">
                  {courses.map((course, idx) => {
                    ...
                    const duration =
                      course.duration ||
                      (course.durationHours ? `${course.durationHours} hrs` : "N/A");
            ...
            <div className="bg-white dark:bg-[#151515] rounded-xl border border-gray-200 dark:border-[#333] shadow-sm p-6">
              ...
              <div className="space-y-5">
                {[
                  {
                    time: "3 hours ago",
                    action: "Category detail metrics regenerated",
                    user: "System Task",
                    icon: Activity,
                  },
                  {
                    time: "1 day ago",
                    action: `New course added to "${category.name}"`,
                    user: "Admin User",
                    icon: BookOpen,
                  },
                  {
                    time: "2 days ago",
                    action: "Category description updated",
                    user: "Admin User",
                    icon: Edit3,
                  },
                  {
                    time: "5 days ago",
                    action: "Visibility set to Public - All Students",
                    user: "Admin User",
                    icon: Eye,
                  },
                  {
                    time: "1 week ago",
                    action: "Category created and initialized",
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#151515] rounded-xl border border-gray-200 dark:border-[#333] shadow-sm p-6">
            <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-5">
              Category Health
            </h3>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-black text-[#6C1D5F] dark:text-[#84117C]">
                    {completionRate}%
                  </span>
                </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="flex items-center gap-2">
                  <span
                    className="w-3.5 h-3.5 rounded-full border border-gray-200 dark:border-[#444]"
                    style={{ backgroundColor: color }}
                  />
                  <span className="font-mono text-gray-700 dark:text-gray-300 uppercase">
                    {color}
                  </span>
                </div>
              </div>
                ...
                <PieChart>
                  ...
                  >
                    {[
                      ...
                      <Cell
                        key={`cell-${index}`}
                        fill={["#6C1D5F", "#01AC9F", "#FF6200", "#F59E0B"][index % 4]}
                      />
                    ))}
                  </Pie>
                  <Tooltip
              ...
              {["Videos", "Quizzes", "Tasks", "Reading"].map((label, idx) => (
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: ["#6C1D5F", "#01AC9F", "#FF6200", "#F59E0B"][idx] }}
                  />
                  {label}
                </div>
              ))}
