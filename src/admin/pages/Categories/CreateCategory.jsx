      ...
      <div className="flex flex-col lg:flex-row gap-6 flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={clsx(
                  ...
                  form.iconType === "emoji"
                    ? "text-white"
                    : "bg-gray-100 dark:bg-[#252535] text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-[#2a2a3a]",
                )}
              ...
              <>
                ...
                >
                  {form.icon && form.icon.startsWith("data:image/") ? (
                    <div
                      className="relative group rounded-full overflow-hidden w-20 h-20 border-2"
                      style={{ borderColor: form.color }}
                    >
                      <img
                        src={form.icon}
                      ...
                      <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-20">
                        <button
                          ...
                          className="text-white bg-destructive p-1 rounded-full pointer-events-auto"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                {PRESET_COLORS.map((c) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      form.color === c && "ring-2 ring-offset-1 ring-gray-400",
                    )}
            ...
            <div className="bg-white dark:bg-[#15151f] border border-gray-200 dark:border-[#2e2e3e] rounded-xl p-5 space-y-3 transition-colors">
              ...
              >
                <div
                  className={clsx(
                    "relative w-12 h-6 rounded-full transition-colors flex items-center px-0.5",
                    form.active ? "bg-[#01AC9F]" : "bg-gray-300 dark:bg-gray-600",
                  )}
                >
                  <div
                    className={clsx(
              ...
              <div
                className={clsx(
                  ...
                  form.active
                    ...
                    : "bg-gray-50 dark:bg-[#1a1a24] text-gray-500 dark:text-gray-400",
                )}
              >
                <span
                  className={clsx(
        ...
        <div className="w-full lg:w-72 shrink-0 flex flex-col gap-4">
              ...
              >
                ...
                >
                  {form.iconType === "url" && form.icon ? (
                    ...
                    <span className="text-[400px] leading-none absolute flex items-center justify-center w-full h-full">
                      {form.icon}
                    </span>
                  ) : null}
                ...
                <div className="flex flex-col flex-1 p-4 pt-3 bg-white dark:bg-[#15151f]">
                  <div>
                    ...
                    <p className="text-[12px] text-gray-600 dark:text-gray-400 mt-1.5 line-clamp-2 leading-relaxed">
                      {form.description ||
                        "Learn the fundamentals of building modern web applications using industry-standard tools and best practices."}
                    </p>
                  </div>
                  <div className="flex items-center gap-3 text-[11px] text-gray-500 dark:text-gray-400 pt-1 border-t border-gray-100 dark:border-[#2e2e3e] mt-3">
                    ...
                    <span className="flex items-center gap-1">
                      <Users className="w-3 h-3" /> 0 Learners
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div key={label} className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span
                      className={clsx(
                        "font-medium",
                        ok ? "text-gray-900 dark:text-white" : "text-destructive",
                      )}
                    >
                      {value}
                    </span>
          ...
          <div className="bg-destructive/10 dark:bg-destructive border border-destructive/20 dark:border-destructive rounded-xl p-4">
            <p className="text-xs font-bold text-destructive dark:text-destructive mb-2">
              Quick Tips
            </p>
          ...
          <div className="bg-white dark:bg-[#15151f] rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                ...
                already exists. Please choose a unique name for this category.
              </p>
              <button
