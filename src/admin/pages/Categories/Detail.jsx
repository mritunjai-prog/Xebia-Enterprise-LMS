      ...
      <div className="h-16 border-b border-[var(--light-gray)] px-8 flex items-center justify-between sticky top-0 bg-[var(--white)]/90 backdrop-blur-md z-40">
        <div className="flex items-center text-sm font-medium">
          ...
          <span className="font-bold text-[var(--black)]">
            {isNew ? "Create New Category" : formData.name || "Edit Category"}
          </span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div
            className="w-8 h-8 rounded-full text-[var(--white)] flex items-center justify-center text-sm font-bold shadow-sm"
      ...
      <div className="max-w-[1800px] w-full mx-auto p-8 grid grid-cols-1 xl:grid-cols-[1fr_400px] gap-10">
        ...
        >
          <motion.div variants={itemVariants}>
            <h1 className="text-[32px] font-bold text-[var(--black)] tracking-tight">
              {isNew ? "Create Category" : "Category Settings"}
            </h1>
            <p className="text-[var(--dark-gray)] mt-2 font-medium">
              Manage the identity, branding, and visibility of this learning category.
            </p>
          </motion.div>

          <motion.div
            variants={itemVariants}
            className="bg-[var(--white)] border border-[var(--light-gray)] rounded-[18px] shadow-[var(--shadow)] p-8 space-y-8"
          >
            <h2 className="text-xl font-bold text-[var(--black)] border-b border-[var(--light-gray)] pb-4 flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[13px] text-[var(--dark-gray)] font-medium mt-0.5">
                  Basic details required to identify this category.
                </span>
              </div>
            </h2>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
              <div>
                <label className="block text-[13px] font-bold text-[var(--black)] mb-2">
                  Category Name <span className="text-[var(--orange)]">*</span>
                </label>
                <div className="relative group">
                  <input
                    ...
                    onFocus={(e) => {
                      ...
                      e.target.style.boxShadow = `0 0 0 4px rgba(1,172,159,0.15)`;
                    }}
                    onBlur={(e) => {
          ...
          >
            <h2 className="text-xl font-bold text-[var(--black)] border-b border-[var(--light-gray)] pb-4 flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[13px] text-[var(--dark-gray)] font-medium mt-0.5">
                  Set the colors and icons for visual identity.
                </span>
              </div>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="block text-[13px] font-bold text-[var(--black)] mb-3">
                  Icon / Thumbnail
                </label>
                <div className="flex items-center gap-1 p-1 bg-[var(--input-bg)] rounded-lg w-max mb-3 border border-[var(--light-gray)]">
                  <button
                    ...
                    className={clsx(
                      ...
                      iconMode === "emoji"
                        ? "bg-[var(--white)] text-[var(--black)] shadow-sm border border-[var(--light-gray)]"
                        : "text-[var(--dark-gray)] hover:text-[var(--black)]",
                    )}
                  >
                    Emoji
                  </button>
                ...
                {iconMode === "upload" ? (
                  ...
                  <input
                    type="text"
                    placeholder={
                      iconMode === "emoji" ? "Type an emoji..." : "https://example.com/image.png"
                    }
                ...
                <div className="flex flex-wrap gap-2">
                  {presetColors.map((c) => (
                    <button
                      ...
                      className={clsx(
                        "w-6 h-6 rounded-full cursor-pointer transition-transform hover:scale-110 shadow-sm border border-[var(--light-gray)]",
                      )}
                      style={{
                        backgroundColor: c,
                        borderColor: formData.color === c ? "var(--white)" : "rgba(0,0,0,0.1)",
                        boxShadow: formData.color === c ? `0 0 0 2px ${c}` : undefined,
                      }}
                    />
                  ))}
                </div>
          ...
          <motion.div
            variants={itemVariants}
            className="bg-[var(--white)] border border-[var(--light-gray)] rounded-[18px] shadow-[var(--shadow)] p-8"
          >
            <h2 className="text-xl font-bold text-[var(--black)] border-b border-[var(--light-gray)] pb-4 mb-6 flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[13px] text-[var(--dark-gray)] font-medium mt-0.5">
                  Control the visibility of this category for learners.
                </span>
              </div>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label
                ...
                style={{
                  borderColor:
                    formData.status === "Active" ? "var(--emerald)" : "var(--light-gray)",
                  backgroundColor:
                    formData.status === "Active" ? `rgba(1,172,159,0.05)` : "var(--white)",
                }}
              ...
              >
                <div
                  ...
                  style={{
                    borderColor: formData.status === "Active" ? "var(--emerald)" : "#d1d5db",
                    backgroundColor:
                      formData.status === "Active" ? "var(--emerald)" : "transparent",
                  }}
                >
                  {formData.status === "Active" && (
                    <div className="w-2 h-2 rounded-full bg-[var(--white)]" />
                  )}
                </div>
                <div>
                  <p
                    ...
                    style={{
                      color: formData.status === "Active" ? "var(--emerald)" : "var(--black)",
                    }}
                  >
                    Active & Visible
                  </p>
                  <p className="text-xs text-[var(--dark-gray)] mt-1 font-medium">
              ...
              <label
                ...
                style={{
                  borderColor:
                    formData.status === "Inactive" ? "var(--dark-gray)" : "var(--light-gray)",
                  backgroundColor:
                    formData.status === "Inactive" ? "var(--input-bg)" : "var(--white)",
                }}
              ...
              >
                <div
                  className="w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 mt-0.5 transition-colors"
                  style={{
                    borderColor: formData.status === "Inactive" ? "var(--dark-gray)" : "#d1d5db",
                    backgroundColor:
                      formData.status === "Inactive" ? "var(--dark-gray)" : "transparent",
                  }}
                >
                ...
                <div>
                  <p
                    className="text-[13px] font-bold"
                    style={{
                      color: formData.status === "Inactive" ? "var(--black)" : "var(--dark-gray)",
                    }}
                  >
                    Inactive (Hidden)
                  </p>
        ...
        >
          <div className="sticky top-24 space-y-6">
            <h3 className="text-[11px] font-bold text-[var(--dark-gray)] uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="bg-[var(--white)] border border-[var(--light-gray)] rounded-[18px] shadow-[var(--shadow-hover)] overflow-hidden transition-all relative z-0 flex flex-col p-0 h-full">
                ...
                >
                  ...
                  (formData.icon.startsWith("http") || formData.icon.startsWith("data:")) ? (
                    ...
                    <span className="text-5xl opacity-40 mix-blend-luminosity drop-shadow-md transition-transform group-hover:scale-110 duration-700">
                      {formData.icon || "📁"}
                    </span>
                  )}
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-xl font-bold text-[var(--black)] group-hover:text-[var(--primary)] transition-colors line-clamp-2">
                    {formData.name || "Category Name"}
                  </h3>
                  <p className="text-[13px] text-[var(--dark-gray)] mt-1.5 line-clamp-2 min-h-[38px] leading-relaxed font-medium">
                    Scope:{" "}
                    {formData.description ||
                      "Learn the fundamentals using industry-standard tools."}
                  </p>
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-4 text-[11px] font-semibold text-[var(--dark-gray)] uppercase tracking-wide">
                    ...
                    <div className="flex items-center gap-1.5">
                      <Users className="w-3.5 h-3.5 text-[#5A5A5A]" />0 Students
                    </div>
                    <div className="flex items-center gap-1.5">
                      <BookOpen className="w-3.5 h-3.5 text-[var(--primary)]" />
                      {courses.filter((c) => c.category === formData.name).length} Course
                      {courses.filter((c) => c.category === formData.name).length !== 1 && "s"}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-[var(--black)] max-w-[140px] truncate">
                      {formData.name || "Not filled"}
                    </span>
                    {formData.name ? (
                      <CheckCircle className="w-4 h-4 text-[var(--emerald)]" />
                    ) : (
                      <div className="w-4 h-4 rounded-full border border-[var(--light-gray)]" />
                    )}
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center text-sm border-t border-[var(--light-gray)] pt-4">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className="font-semibold text-[var(--black)] font-mono text-[11px] uppercase"
            ...
            >
              <h4 className="text-[13px] font-bold text-[var(--black)] mb-5 flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <BarChart2 className="w-4 h-4 text-[var(--primary)]" /> Category Insights
                </span>
                <span className="text-[10px] font-semibold text-[var(--emerald)] bg-[var(--emerald)]/10 px-2 py-0.5 rounded-full">
                  +24%
                </span>
              </h4>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    <XAxis
                      ...
                      axisLine={false}
                      tickLine={false}
                      tick={{ fontSize: 10, fill: "var(--dark-gray)", fontWeight: 600 }}
                      dy={10}
                    />
                    <YAxis
                      axisLine={false}
              ...
              <p className="text-xs text-[var(--dark-gray)] mt-4 font-medium text-center">
                Projected student enrollments for this category.
              </p>
            </motion.div>
            ...
            >
              <h4 className="text-[13px] font-bold text-[var(--black)] mb-5 flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <PieChartIcon className="w-4 h-4 text-[var(--primary)]" /> Content Distribution
                </span>
              </h4>
              ...
              <div className="flex justify-center gap-5 mt-4">
                {mockPieData.map((entry, index) => (
                  <div
                    key={entry.name}
                    className="flex items-center gap-2 text-[11px] font-bold text-[var(--dark-gray)] uppercase tracking-wide"
                  >
                    <span
              ...
              >
                ...
                <div className="divide-y divide-[var(--light-gray)] max-h-64 overflow-y-auto">
                  {courses.filter((c) => c.category === formData.name).length > 0 ? (
                    courses
                      .filter((c) => c.category === formData.name)
                      .map((course) => (
                        <div
                          key={course.id}
                          className="p-4 flex items-center justify-between hover:bg-[var(--input-bg)] transition-colors cursor-pointer"
                          onClick={() => router.navigate({ to: `/admin/courses/${course.id}` })}
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-[13px] font-bold text-[var(--black)]">
                                {course.title}
                              </p>
                              <p className="text-[11px] font-medium text-[var(--dark-gray)] line-clamp-1">
                                {course.scope || "No Scope"}
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="p-8 text-center">
                      <p className="text-sm text-[var(--dark-gray)] font-medium">
                        No courses are enrolled in this category yet.
                      </p>
                      <button
                        onClick={() => router.navigate({ to: "/admin/courses/new" })}
                        className="mt-3 text-[12px] font-bold text-[var(--primary)] hover:underline"
                      >
                        Create Course &rarr;
                      </button>
                    </div>
      ...
      <AnimatePresence>
        {successMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-20 left-1/2 -translate-x-1/2 bg-gray-900 text-[var(--white)] rounded-xl px-5 py-3 flex items-center gap-3 shadow-2xl z-50"
          >
            <CheckCircle className="w-5 h-5 text-[var(--emerald)]" />
            <span className="font-semibold text-sm">{successMessage}</span>
            <button
              onClick={() => setSuccessMessage("")}
              className="ml-2 text-[var(--dark-gray)] hover:text-[var(--white)]"
            >
              <X className="w-4 h-4" />
            </button>
          </motion.div>
