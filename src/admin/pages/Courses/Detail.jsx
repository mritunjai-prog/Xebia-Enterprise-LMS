                  ...
                  >
                    <div className="space-y-8 pb-20 mt-4">
                      ...
                      <div className={clsx(editorTab !== "seo" && "hidden")}>
                        <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Globe className="w-5 h-5 text-emerald-500" /> Search Engine Optimization
                        </h3>
                        <div className="space-y-6">
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                maxLength={70}
                                className="w-full px-3 py-2 bg-white border border-gray-300 shadow-sm focus-within:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-[12px] text-sm outline-none focus:border-emerald-500"
                            ...
                            <div>
                              ...
                              <textarea
                                rows={2}
                                maxLength={320}
                                className="w-full px-3 py-2 bg-white border border-gray-300 shadow-sm focus-within:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-[12px] text-sm outline-none focus:border-emerald-500 resize-none"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <textarea
                                  ...
                                  className="w-full px-3 py-2 bg-white border border-gray-300 shadow-sm focus-within:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-[12px] text-sm outline-none focus:border-purple-500 resize-none"
                          ...
                          <div className="border-t border-gray-200 pt-5 space-y-4">
                            ...
                            <div>
                              ...
                              <textarea
                                rows={3}
                                placeholder="Q: ... A: ..."
                                className="w-full px-3 py-2 bg-white border border-gray-300 shadow-sm focus-within:border-indigo-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-[12px] text-sm outline-none focus:border-amber-500 resize-none font-mono"
                      ...
                      <div className={clsx(editorTab !== "settings" && "hidden")}>
                        <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Settings className="w-5 h-5 text-amber-500" /> Platform Settings
                        </h3>
                        <div className="space-y-5">
