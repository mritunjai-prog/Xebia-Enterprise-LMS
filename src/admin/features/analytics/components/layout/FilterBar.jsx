      ...
      <div className="flex items-center gap-1.5 bg-white dark:bg-[#15151f] p-1.5 rounded-xl border border-gray-200 dark:border-[#2e2e3e] shadow-sm">
        ...
        <div className="flex items-center">
          <Select value={filters.time.type} onValueChange={handleTimeTypeChange}>
            ...
            <SelectContent>
              <SelectItem value="Year" className="text-xs font-medium">Year-wise</SelectItem>
              <SelectItem value="Quarter" className="text-xs font-medium">Quarter-wise</SelectItem>
              <SelectItem value="Half-Year" className="text-xs font-medium">Half-Yearly</SelectItem>
              <SelectItem value="Month" className="text-xs font-medium">Monthly</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        {/* Region Filter */}
        <div className="flex items-center">
          <Select value={filters.organization.region} onValueChange={(val) => handleOrgChange('region', val)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="NA" className="text-xs font-medium">North America</SelectItem>
              <SelectItem value="EMEA" className="text-xs font-medium">EMEA</SelectItem>
              <SelectItem value="APAC" className="text-xs font-medium">APAC</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        {/* Department Filter */}
        <div className="flex items-center">
          <Select value={filters.organization.department} onValueChange={(val) => handleOrgChange('department', val)}>
            <SelectTrigger className="w-[130px] h-8 text-xs font-bold bg-transparent border-none focus:ring-0 shadow-none hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors">
            ...
            <SelectContent>
              ...
              <SelectItem value="Sales" className="text-xs font-medium">Sales</SelectItem>
              <SelectItem value="HR" className="text-xs font-medium">HR</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
