          ...
          <ResponsiveContainer width="100%" height="100%">
            <RechartsFunnelChart>
              ...
              <Funnel
                ...
                isAnimationActive
              >
                <LabelList position="right" fill="currentColor" stroke="none" dataKey={nameKey} style={{ fontSize: '12px', fontWeight: 'bold', opacity: 0.7 }} />
                <LabelList position="inside" fill="#fff" stroke="none" dataKey={dataKey} style={{ fontSize: '14px', fontWeight: '900', textShadow: '0 2px 4px rgba(0,0,0,0.5)' }} />
              </Funnel>
            </RechartsFunnelChart>
          </ResponsiveContainer>
        </div>
