...
export function MetricCard({ title, value, icon: Icon, trend, trendValue, description, className, iconClassName, sparkline }) {
  return (
    <div className={clsx(
      ...
      <div className="flex items-start justify-between mb-4 relative z-10">
        ...
        {Icon && (
          <div className={clsx("w-12 h-12 rounded-xl flex items-center justify-center shrink-0 bg-white/50 dark:bg-black/20 shadow-[inset_0_1px_2px_rgba(255,255,255,0.4)] dark:shadow-[inset_0_1px_2px_rgba(255,255,255,0.05)] border border-white/40 dark:border-white/10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500", iconClassName)}>
